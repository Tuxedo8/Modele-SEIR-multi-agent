 ...
 *         canonical method nextRandom() for generating bits in the pseudo
 *         random
 ...
 *         src="http://creativecommons.org/images/public/cc-LGPL-a.png"
 *         /></a><br />
...
public class MTRandom extends Random {
	 ...
	 * serialisation of its Randominternal state and it may even be necessary to
	 ...
	 * 
	 * This constructor was modified due to be compliant to the JDK7's
	 * implementation
	...
	public double genRand1() {

		return genRandInt32() * (2.0 / 4294967295.0);
	}

	public double negExp(double inMean) {
		return -inMean * Math.log(1 - this.genRand1());
